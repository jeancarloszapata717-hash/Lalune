...
export default function Catalog() {
  ...
  const predefinedCategories = [
    'PROMOS DEL DIA', 'NEW INN', 'TORTAS COMPLETAS', 'CAJAS VARIADAS', 'IMPERDIBLES',
    'MENU SALUDABLES', 'CINNAMONS', 'BROWNIE AND BLONDIE BITES', 'COOKIES', 
    'PORCIONES PEQUEÑAS', 'PAVLOVA', 'BEBIDAS'
  ];
  const categories = ['todos', ...predefinedCategories];
  ...
  const handleRandomRecommend = () => {
    ...
    const randomProduct = MOCK_PRODUCTS[randomIndex];
