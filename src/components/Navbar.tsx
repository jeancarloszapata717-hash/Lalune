                ...
                <AnimatePresence>
                  {userMenuOpen && (
                    ...
                    >
                      ...
                      <button onClick={() => { setUserMenuOpen(false); /* navigate to coupons */ }} className="w-full text-left px-5 py-3 text-sm font-bold text-brand-dark hover:bg-brand-lavender/20 hover:text-brand-hotpink transition-colors">
                        Mis Cupones
                      </button>
